...
struct EmojiArtDocumentView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            documentBody
            PaletteChooser(emojiiFontSize: defaultEmojiFontSize)
        }
    }
    ...
    @SceneStorage("EmojiArcDocumentView.steadyStatePanOffset")
    ...
    @SceneStorage("EmojiArcDocumentView.steadyStateZoomScale")
